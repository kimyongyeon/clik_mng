...
// 				url = "/mdm/MdmPolicyInfoMetaDataView1.do?cnId="+cnList[i-1];
				frm.action = "/mdm/MdmEduManualMetaDataView2.do";
...
function openServicePopup(){
	window.open('http://clik.nanet.go.kr/potal/search/searchView.do?collection=manual&DOCID=${policyInfoVO.OUTBBS_CN}','_blank');
}
</script>
</head>
				...
				<div class="table-responsive" id="leftArea">
					<table class="table table-striped table-bordered " style="table-layout:fixed;">
						...
						<tbody>
							...
							<tr>	
								<th>제어번호</th>
								<td colspan="6">${policyInfoVO.OUTBBS_CN}</div>
								</td>
							</tr>
							<tr>	
								<th>자료유형</th>

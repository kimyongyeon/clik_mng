...
<jsp:include page="/cmm/top/top.do" />
	...
	<div id="page-wrapper">
		...
		<form id="regForm" name="regForm">
			...
			<table class="table table-striped table-bordered table-hover " id="">
				...
				<tbody>
						...
						<td>
							<select name="dtaSeCode" class=" input-sm" style="width:30%;">
								<c:forEach var="x" items="${codeList}" varStatus="s">
									<option value="${x.code}">${x.code} (${x.codeNm})</option>
								</c:forEach>
							</select>
						</td>
					</tr>
					<tr>
						<th>등록번호 1번째 자리</th>
						<td><input type="text" name="registNo" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>청구(DDC) 082.a</th>
						<td><input type="text" name="ddc" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>별치(PL)</th>
						<td><input type="text" name="pl" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>배가(SL)</th>
						<td><input type="text" name="sl" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>자료구분</th>
						<td><input type="text" name="dtaSe" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>발행년도</th>
						<td><input type="text" name="pblicteYear" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>Position</th>
						<td><input type="text" name="postn" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>위치</th>
						<td><input type="text" name="postnLc" class="ip input-sm" style="width:30%;"></td>
					</tr>
					<tr>
						<th>프린트 아이디/설명</th>
						<td>
							<input type="text" name="printId" class="ip input-sm" style="width:20%;">
							<input type="text" name="printIdDc" class="ip input-sm" style="width:60%;">
						</td>
					</tr>
					<tr>
						<th>CN_TYPE</th>
						<td>
							<input type="text" name="cnType" class="ip input-sm" style="width:30%;">
						</td>
					</tr>
					<tr>
						<th>온라인 열람 권한</th>
						<td>
							<input type="radio" name="openCode[L]" value="Y" checked> O
							&nbsp;&nbsp;&nbsp;
							<input type="radio"name="openCode[L]" value="N"> X
						</td>
					</tr>
					<tr>
						<th>야간이용 권한</th>
						<td>
							<input type="radio" name="openCode[R]" value="Y" checked> O
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="openCode[R]" value="N"> X
						</td>
					</tr>
					<tr>
						<th>국회의원 대출 권한</th>
						<td>
							<input type="radio" name="openCode[O]" value="Y" checked> O
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="openCode[O]" value="N"> X
						</td>
					</tr>
				</tbody>
			</table>
		...
		<p class="tr">
			<button type="button" class="btn btn-default" onclick="javascript:fnElmCrpList();">목록</button>

...
<c:if test="${searchList == '1'}">
   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 일반주소 수정</h1></td>
</c:if>
<c:if test="${searchList == '2'}">
   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 도로명주소 수정</h1></td>
</c:if>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">우편번호 수정</CAPTION>
  <c:if test="${searchList == '1'}">
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap >우편번호<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>          
	    <td width="80%" nowrap colspan="3">
	    	<c:out value='${fn:substring(zip.zip, 0,3)}'/>-<c:out value='${fn:substring(zip.zip, 3,6)}'/>
	    </td>
	  </tr> 
	  <tr> 
	    <th width="20%" height="23" class="required_text" scope="row" nowrap >시도명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	    	<c:out value='${zip.ctprvnNm}'/>
	    </td>    
	  </tr>
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap >시군구명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>          
	    <td width="80%" nowrap>
	    	<c:out value='${zip.signguNm}'/>
	    </td>    
	  </tr> 
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap >읍면동명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>          
	    <td width="80%" nowrap>
  ...
  <c:if test="${searchList == '2'}">
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap >우편번호<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td><c:out value='${fn:substring(zip.zip, 0,3)}'/>-<c:out value='${fn:substring(zip.zip, 3,6)}'/></td>
	  </tr>
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap >도로명코드<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td><c:out value='${zip.rdmnCode}'/></td>
	  </tr>
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap >시도명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td><c:out value='${zip.ctprvnNm}'/>}</td>
	  </tr>
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap >시군구명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td><c:out value='${zip.signguNm}'/></td>
	  </tr>
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap >도로명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>

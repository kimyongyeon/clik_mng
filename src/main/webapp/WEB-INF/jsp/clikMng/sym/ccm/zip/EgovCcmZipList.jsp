...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="18%"class="title_left"><h1 class="title_left">
   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif'/>" width="16" height="16" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 목록</h1></td>
  <td width="10%" >
  ...
  <td width="10%">
	...
	<td width="23%">
	    <input name="searchKeyword" type="text" value="${searchVO.searchKeyword}" id="searchKeyword" class="ip input-sm input-search">
    </td>
      <td width="28%" >
	      <span class="button"><input type="submit" value="<spring:message code="button.search" />" onclick="fn_egov_search_Zip(); return false;"></span>

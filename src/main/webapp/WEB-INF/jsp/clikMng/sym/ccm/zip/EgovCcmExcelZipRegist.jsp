...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <c:if test ="${searchList == '1'}">
	<img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 일반주소 엑셀파일 등록</h1></td>
  </c:if>
  <c:if test ="${searchList == '2'}">
	<img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 도로명주소 엑셀파일 등록</h1></td>
  </c:if>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">우편번호 엑셀파일 등록</CAPTION>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="fileNm">우편번호 엑셀파일</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>

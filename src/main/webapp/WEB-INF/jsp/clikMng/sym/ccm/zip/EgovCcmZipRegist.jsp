...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <c:if test="${searchList == '1'}">
   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 일반주소 등록</h1></td>
  </c:if>
  <c:if test="${searchList == '2'}">
   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;우편번호 도로명주소 등록</h1></td>
  </c:if>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">우편번호 등록</CAPTION>
  <c:if test="${searchList == '1'}">
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="zip">우편번호</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="ctprvnNm">시도명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="signguNm">시군구명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="emdNm">읍면동명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
  ...
  <c:if test="${searchList == '2'}">
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap ><label for="zip">우편번호</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	      <form:input  path="zip" size="6" maxlength="6" id="zip"/>
	      <form:errors path="zip"/> &nbsp;* 우편번호의 '-'를 제외하고 입력하시오.
	    </td>
  	  ...
  	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap ><label for="rdmnCode">도로명코드</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	  ...
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap ><label for="ctprvnNm">시도명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	      <form:input  path="ctprvnNm" size="20" maxlength="20" id="ctprvnNm"/>
	      <form:errors path="ctprvnNm"/>
	    </td>
	  ...
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap ><label for="signguNm">시군구명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
	      <form:input  path="signguNm" size="20" maxlength="20" id="signguNm"/>
	      <form:errors path="signguNm"/>
	    </td>
	  ...
	  <tr>
	    <th width="11%" height="23" class="required_text" scope="row" nowrap ><label for="rdmn">도로명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
	    <td width="80%" nowrap>
...
<tr>
<!-- 
  <td><img src="<c:url value='/images/clikmng/cmm/btn/bu2_left.gif' />" alt="목록" width="8" height="20"></td>
  <td style="background-image:URL(<c:url value='/images/clikmng/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fn_egov_list_Zip(); return false;">목록</a></td>
  <td><img src="<c:url value='/images/clikmng/cmm/btn/bu2_right.gif' />" alt="목록" width="8" height="20"></td>
  <td width="10"></td>
-->

...
<input type="hidden" name="posblAtchFileNumber" value="3" />
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%" class="title_left"><h1 class="title_left">
	   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;시스템 이력등록</h1></td>
	 </tr>
	</table>
	 ...
	 <tr>
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row">
	    	...
	    	<img src="<c:url value='/images/clikmng/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시">
	    </th>
	    <td width="80%" nowrap>
	...
	<tr>
	  <!--
      <td><img src="<c:url value='/images/clikmng/cmm/btn/bu2_left.gif'/>" width="8" height="20" alt=""></td>

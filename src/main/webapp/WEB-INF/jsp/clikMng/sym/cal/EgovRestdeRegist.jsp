...
<script type="text/javascript" src="<c:url value='/js/clikMng/com/sym/cal/EgovCalPopup.js' />" ></script>
...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left"><h1 class="title_left">
   <img src="<c:url value='/images/clikMng/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;휴일 등록</h1></td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">휴일 등록</CAPTION>
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >휴일일자<img src="<c:url value='/images/clikMng/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"  style="vertical-align: middle"></th>
    <td width="80%" nowrap>
		...
		<a href="#noscript" onclick="fn_egov_NormalCalendar(document.restde, document.restde.restdeDe, document.restde.vrestdeDe); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/clikMng/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>
   	</td>
  </tr>
  <tr>
...
<tr>
  ...
  <td><img src="<c:url value='/images/clikMng/com/cmm/btn/bu2_left.gif' />" alt="저장" width="8" height="20"></td>
  <td style="background-image:URL(<c:url value='/images/clikMng/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fn_egov_regist_Restde(document.restde); return false;">저장</a></td>
  <td><img src="<c:url value='/images/clikMng/com/cmm/btn/bu2_right.gif' />" alt="저장" width="8" height="20"></td>
</tr>
</table>

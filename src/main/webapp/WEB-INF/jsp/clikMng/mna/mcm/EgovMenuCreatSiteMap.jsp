...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/clikmng/mna/mcm/EgovMenuCreatSiteMap.js' />"></script>
...
//var vSiteMapPath = "/html/egovframework/com/mna/mcm/";
...
function selectMenuCreatSiteMap() {
	...
	document.menuCreatManageSiteMapForm.action = "<c:url value='/mna/mcm/EgovMenuCreatSiteMapSelect.do'/>";
...
function CreatSiteMap() {
	...
	document.menuCreatManageSiteMapForm.action = "<c:url value='/mna/mcm/EgovMenuCreatSiteMapInsert.do'/>";
    document.menuCreatManageSiteMapForm.submit();
}
...
<form name="menuCreatManageSiteMapForm" action ="<c:url value='/mna/mcm/EgovMenuCreatSiteMapSelect.do' />" method="post">
...
<table width="490" cellpadding="8" class="table-search" border="0" align="center">
 <tr>
  ...
  <h1><img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;메뉴사이트맵생성</h1></td>
  <td width="10%"></td>
  <td width="25%"></td>
  <th width="25%">

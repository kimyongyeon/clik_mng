...
function fncAddAuthorInsert() {
    location.href = "/mna/ram/EgovAuthorInsertView.do?authorClCode=CLIK";
}
...
/* 
    ...
    document.listForm.action = "<c:url value='/mna/ram/EgovAuthorRoleList.do'/>";
    document.listForm.submit();
 */    
}
...
<div id="page-wrapper">        
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">메뉴 및 기능제한 설정</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /row -->
			...
			<div class="panel-heading">메뉴 및 기능제한설정 목록조회</div>
			<!-- /.panel-heading -->	
			...
			<ul class="nav nav-tabs">
				...
				<input type="hidden" id="authorClCode" name="authorClCode" >

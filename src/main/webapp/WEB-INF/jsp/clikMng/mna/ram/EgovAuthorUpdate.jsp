...
<title>기능권한 상세보기 및 수정</title>
<script type="text/javascript" src="<c:url value="/validator.do"/>"></script>
<validator:javascript formName="authorManage" staticJavascript="false" xhtml="true" cdata="false"/>
<script type="text/javaScript" language="javascript">

function fncSelectAuthorList() {
	location.href="/mna/ram/EgovAuthorList.do?authorClCode=<c:out value="${authorManage.authorClCode}" />";
/* 	
...
<div id="page-wrapper">        
    ...
    <form:form commandName="authorManage" method="post" >
			...
			<div class="panel-heading">기능권한 상세보기 및 수정</div>

				<table border="0" width="100%">
				  <tr>
				    <td>
				
				<table width="100%" cellpadding="8" class="table table-striped table-bordered " summary="권한을 수정하는 테이블입니다.권한 코드,권한 명,설명,등록일자 정보를 담고 있습니다.">
				  <tr>
				    ...
				    <td class="lt_text" nowrap="nowrap">
				    	<input type="radio" id="authorClCode" name="authorClCode" value="CLIK" <c:if test="${authorManage.authorClCode == 'CLIK'}">checked</c:if> /> 사용자 기능 &nbsp;
				    	<input type="radio" id="authorClCode" name="authorClCode" value="MNG" <c:if test="${authorManage.authorClCode == 'MNG'}">checked</c:if> /> 관리자 기능 
				    </td>
				  </tr>	
				  <tr>
				    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">권한  코드<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
				    <td nowrap="nowrap"><input name="authorCode" id="authorCode" type="text" readonly="readonly" value="<c:out value='${authorManage.authorCode}'/>" size="40" title="권한코드" class="form-control span1" style="width:200px;"/>&nbsp;<form:errors path="authorCode" /></td>
				
				  </tr>
				  <tr>
				    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">권한 명<img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
				    <td nowrap="nowrap"><input name="authorNm" id="authorNm" type="text" value="<c:out value='${authorManage.authorNm}'/>" maxLength="50" size="40" title="권한명" class="form-control span1" style="width:200px;"/>&nbsp;<form:errors path="authorNm" /></td>
				
				  </tr>
				  <tr>
				    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">설명</th>
				    <td nowrap="nowrap"><input name="authorDc" id="authorDc" type="text" value="<c:out value='${authorManage.authorDc}'/>" maxLength="50" size="50" title="설명" class="form-control span1" style="width:200px;"/></td>
				  </tr>
				  <tr>

...
<DIV id="page-wrapper">        
	...
	<p class="tr">
		<button type="button" class="btn btn-default" onclick="javascript:fncSelectRoleList('${roleClCode}')">목록</button>		
		...
		<DIV class="">
			...
			<DIV id="main" class="panel-body">
				...
				<table width="100%" cellpadding="8" class="table table-striped table-bordered" summary="기능 등록 테이블입니다.기능 코드,기능 명,기능 패턴,설명,기능 타입,기능 Sort,등록일자의 정보를 담고 있습니다.">
				  <tr>
				    ...
				    <td class="lt_text" nowrap="nowrap">
				    	<input type="radio" id="roleClCode" name="roleClCode" value="CLIK" checked /> 사용자 기능 &nbsp;
				    	<input type="radio" id="roleClCode" name="roleClCode" value="MNG" /> 관리자 기능 
				    </td>
				  </tr>				
				  <tr>
				    ...
				    <td class="lt_text" nowrap="nowrap"><input name="roleCode" id="roleCode" type="text" value="<c:out value='${roleManage.roleCode}'/>" size="30" title="기능 코드" readonly="readonly" class="form-control input-sm" /></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
				    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">설명<img src="<c:url value='/images/clikmng/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
				  ...
				  <tr>
				    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">등록일자<img src="<c:url value='/images/clikmng/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
				    <td class="lt_text" nowrap="nowrap"><input name="roleCreatDe" id="roleCreatDe" type="text" value="<c:out value='${roleManage.roleCreatDe}'/>" maxLength="50" size="20" readonly="readonly" title="등록일자" class="form-control input-sm"/></td>
				  </tr>
				</table>

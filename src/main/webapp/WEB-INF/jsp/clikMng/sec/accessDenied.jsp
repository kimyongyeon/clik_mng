        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><img src="<c:url value='/images/clikmng/cmm/er_logo.jpg' />" width="379" height="57" alt="에러로고이미지"/></td>
              </tr>
              <tr>
                <td><br />
                  <br /></td>
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    <td width="74" rowspan="2" align="center"><img src="<c:url value='/images/clikmng/cmm/danger.jpg' alt="경고이미지"/>" width="74" height="74" /></td>
              ...
              <tr>
                <td align="center"><a href="javascript:fncGoAfterErrorPage();"><img src="<c:url value='/images/clikmng/cmm/go_history.jpg' />" width="90" height="29" border="0" alt="바로가기 버튼이미지"/></a></td>
              </tr>
            </table>
              <br /></td>
          </tr>

	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목버튼이미지">&nbsp;게시판 정보수정</td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  ...
	  <tr>
	    ...
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="javascript:fn_egov_inqire_tmplatInqire();"><img src="<c:url value='/images/clikmng/cmm/icon/search.gif' />"

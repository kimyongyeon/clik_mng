...
td.bgB {background:#fff url(<c:url value='/images/clikmng/cop/tpl/temple_top01.jpg'/>) repeat-y;}
.mid { background:url(<c:url value='/images/clikmng/cop/tpl/1_step_bg.gif' />) repeat-x; }
.meMid { background:url(<c:url value='/images/clikmng/cmm/left_menu_bg.gif' />) repeat-y; }
table.me{background:url(<c:url value='/images/clikmng/cop/tpl/top_menu_bg.gif' />) repeat-x; }
</style>
...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="16" height="18" alt="menu gap" /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="169" valign="top"><table width="169" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="13"><img src="<c:url value='/images/clikmng/cop/tpl/left_menu_top.gif' />" width="169" height="13" alt="left menu top"/></td>
          </tr>
          <tr>

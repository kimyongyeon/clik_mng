...
td.rightGap {background:url(<c:url value='/images/clikmng/cop/tpl/right_gap.gif'/>) }
</style>
<c:choose>
			...
			<tr>
				<td align="center" valign="top" width="330"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[0].bbsId}" />','<c:out value="${bbsList[0].bbsAttrbCode}" />');"><img src="<c:url value='/images/clikmng/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
								<td width="100%" class="rightGap"><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
								<td><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
							</tr>
							<tr>
								<td height="9" class="rightGap"><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지"/></td>
								<td width="100%" height="9"><table width="100%" border="0" cellspacing="0" cellpadding="2">
									<tr>
										...
										<c:forEach var="article" items="${articleList[0]}" varStatus="status">
											<tr>
												<td height="22" align="left"><span class="right_board_date"><img src="<c:url value='/images/clikmng/cop/tpl/dot.gif' />" width="12" height="4" alt="도트이미지"/>
				...
				<td align="center"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="20" height="23" alt="여백이미지" /></td>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[1].bbsId}" />','<c:out value="${bbsList[1].bbsAttrbCode}" />');"><img src="<c:url value='/images/clikmng/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[2].bbsId}" />','<c:out value="${bbsList[2].bbsAttrbCode}" />');"><img src="<c:url value='/images/clikmng/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
				...
				<td align="center"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="20" height="23" alt="spacer" /></td>
				<td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[3].bbsId}" />','<c:out value="${bbsList[3].bbsAttrbCode}" />');"><img src="<c:url value='/images/clikmng/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>

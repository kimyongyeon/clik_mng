...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="16"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="16" height="23" alt="spacer" /></td>
        <td height="45"><img src="<c:url value='/images/clikmng/cop/tpl/logo_com.gif' />" width="105" height="35" alt="logo" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
        ...
        <td><table width="917" border="0" cellpadding="0" cellspacing="0" bgcolor="d9dde1">
          <tr>
            <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="74" align="left" background="<c:url value='/images/clikmng/cop/tpl/temple_top01.jpg' />" bgcolor="#FFFFFF"><table width="200" border="0" cellspacing="2" cellpadding="3">
                  <tr>
  ...
  <tr>
    <td><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="18" height="23" alt="spacer" /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="16"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="16" height="23" alt="spacer" /></td>
        <td align="left"><table width="917" border="0" cellpadding="0" cellspacing="0" background="<c:url value='/images/clikmng/cop/tpl/top_menu_bg.gif' />">
          <tr>
            <td width="13"><img src="<c:url value='/images/clikmng/cop/tpl/top_menu_left.gif' />" width="13" height="41" alt="menu left" /></td>
            <td align="left"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td align="center"><img src="<c:url value='/images/clikmng/cop/tpl/top_menu_gap.gif' />" width="8" height="41" alt="menu gap" /></td>
            ...
            <td width="13" align="right"><img src="<c:url value='/images/clikmng/cop/tpl/top_menu_right.gif' />" width="13" height="41" alt="menu right" /></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="16" height="18" alt="spacer" /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="16"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="16" height="23" alt="menu gap" /></td>
        <td width="169" valign="top"><table width="169" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="13"><img src="<c:url value='/images/clikmng/cop/tpl/left_menu_top.gif' />" width="169" height="13" alt="left menu" /></td>
          </tr>
          <tr>
            <td align="center" background="<c:url value='/images/clikmng/cmm/left_menu_bg.gif' />"><table width="145" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="21"><img src="<c:url value='/images/clikmng/cop/tpl/1_step_left.gif' />" width="21" height="23" alt="left menu" /></td>
                    <td align="left" background="<c:url value='/images/clikmng/cop/tpl/1_step_bg.gif' />" class="f_step">게시판 목록</td>
                    <td width="6"><img src="<c:url value='/images/clikmng/cop/tpl/1_step_right.gif' />" width="6" height="23" alt="left menu" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td align="left"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="18" height="7" alt="spacer" /></td>
              </tr>
			...
			<c:forEach var="bbs" items="${bbsList}" varStatus="status">
              <tr>
                <td align="left"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                  <tr>
                    <td width="21" height="13" style="padding-left:10px; padding-right:3px;"><img src="<c:url value='/images/clikmng/cop/tpl/bull.gif' />" width="21" height="11" alt="bull" /></td>
			...
			<c:if test="${isAuthenticated=='Y'}">
              ...
              <tr>
                <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="21"><img src="<c:url value='/images/clikmng/cop/tpl/1_step_left.gif' />" width="21" height="23" alt="left menu" /></td>
                    <td align="left" background="<c:url value='/images/clikmng/cop/tpl/1_step_bg.gif' />" class="f_step">
					<c:choose>
          ...
          <tr>
            <td height="13"><img src="<c:url value='/images/clikmng/cop/tpl/left_menu_bottom.gif' />" width="169" height="13" alt="left menu" /></td>
          </tr>
        </table></td>
        <!-- td width="15" valign="top"><img src="<c:url value='/images/clikmng/cop/tpl/gray_white.gif' />" width="15" height="23" /></td-->
        <td valign="top">
        <c:choose>
		<c:when test="${preview == 'true'}">
        	<!--  컨텐츠 영역 : Start -->

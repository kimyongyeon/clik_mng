					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100%" style="background-image : url(${pageContext.request.contextPath}/images/clikmng/cop/tpl/right_gap.gif);" ><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" ></td>
								<td><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
							</tr>
							<tr>
								<td height="9" style="background-image : url(${pageContext.request.contextPath}/images/clikmng/cop/tpl/right_gap.gif);"><img src="<c:url value='/images/clikmng/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>

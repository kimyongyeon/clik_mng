...
<div id="border" style="width:730px">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0" id="cmyList" summary="커뮤니티 목록입니다.">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;커뮤니티 목록
	  	</h1>
	  </td>
	 </tr>
	 <tr>
	...
	<table width="100%" cellpadding="8" class="table-search" border="0" id="clubList" summary="동호회 목록입니다.">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;동호회 목록
	  	</h1>
	  </td>
	 </tr>
	 <tr>

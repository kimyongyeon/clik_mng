...
function fn_egov_inqire_faqlist() {
	...
	document.FaqManageForm.action = "<c:url value='/cop/faq/FaqListInqire.do'/>";
...
function fn_egov_updt_faq(faqId){
	...
	document.FaqManageForm.action = "<c:url value='/cop/faq/FaqCnUpdtView.do'/>";
	document.FaqManageForm.submit();	
...
function fn_egov_delete_faq(faqId){
	...
	if	(confirm("<spring:message code="common.delete.msg" />"))	{	
		...
		document.FaqManageForm.faqId.value = faqId;	
		document.FaqManageForm.action = "<c:url value='/cop/faq/FaqCnDelete.do'/>";
		document.FaqManageForm.submit();
...
<DIV id="page-wrapper">        
    ...
    <!-- /row -->
			...
			<DIV class="panel-heading">
				...
				<!-- 상단타이틀 -->
				<form name="FaqManageForm" action="<c:url value='/cop/faq/FaqCnUpdtView.do'/>" method="post">
				...
				<!-- 등록  폼 영역  -->
				<table width="98%" border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" summary="FAQ에 대한 정보를  조회합니다.">
				  <tr> 
				  ...
				  <tr> 
				    ...
				    <td width="80%" nowrap>
				      <textarea name="qestnCn" class="textarea"  cols="300" rows="15"  style="width:100%;"  title="질문내용"><c:out value="${result.qestnCn}"/></textarea>                   
				    </td>
				  </tr>
				  ...
				  <tr> 
				    ...
				    <td width="80%" nowrap>
				      <textarea name="answerCn" class="textarea"  cols="300" rows="15"  style="width:100%;"  title="답변내용"><c:out value="${result.answerCn}"/></textarea>                   
				    </td>
				  </tr>
				...
				<p class="tr">
					<button type="button" class="btn btn-default" onclick="fn_egov_inqire_faqlist(); return false;"><spring:message code="button.list" /></button>	
					<button type="button" class="btn btn-success" onclick="fn_egov_updt_faq('<c:out value="${result.faqId}"/>'); return false;""><spring:message code="button.update" /></button>

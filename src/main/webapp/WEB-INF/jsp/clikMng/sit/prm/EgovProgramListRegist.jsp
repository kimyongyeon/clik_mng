...
<DIV id="page-wrapper">        
    ...
    <!-- /row -->
		<p class="tr">					
			...
			<button type="button" class="btn btn-primary" onclick="insertProgramListManage(document.forms[0]); return false;"><spring:message code="button.create" /></button>												
			<!--
	...
	<div id="border" style="display:" class="col-lg-12">
		<DIV class="panel panel-default">
			...
			<DIV id="border" class="panel-body">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" summary="프로그램목록 등록">
				  <tr>
				    ...
				    <td width="80%" nowrap>
				      &nbsp;
				      <form:input path="progrmFileNm" size="50"  maxlength="50" id="F1" title="프로그램파일명" class="form-control input-sm"/>
				  ...
				  <tr>
				    ...
				    <td width="80%" nowrap>
				      &nbsp; <form:input path="progrmStrePath"  size="60"   maxlength="60" title="저장경로" class="form-control input-sm"/>

...
function searchFileNm() {
	...
	window.open("<c:url value='/sit/prm/EgovProgramListSearch.do' />",'','width=500,height=600');
}
...
function updateProgrmChangeRequst(form) {
	if(confirm("<spring:message code="common.save.msg"/>")){
		if(!validateProgrmManageDtlVO(form)){
            ...
            form.action ="<c:url value='/sit/prm/EgovProgramChangRequstDetailSelectUpdt.do'/>";
			form.submit();
		}
	}
}
...
function deleteProgrmChangeRequst(form) {
	form.action = "<c:url value='/sit/prm/EgovProgramChangRequstDelete.do'/>";
	form.submit();
}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/sit/prm/EgovProgramChangeRequstSelect.do' />";
}
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;프로그램변경요청 상세조회 /수정</h1></td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/clikmng/sit/prm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;변경요청내역</td>
 </tr>
</table>
...
<tr>
      <td width="90%"></td>
  	  <td><span class="button"><a href="<c:url value='/sit/prm/EgovProgramChangeRequstSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>
	  <td width="2%"></td>

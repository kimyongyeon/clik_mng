...
<link rel="stylesheet" href="<c:url value='/css/clikmng/list.css' />" type="text/css">
...
//	document.progrmChangeRequstForm.searchKeyword.value =
	...
	document.progrmChangeRequstForm.action = "<c:url value='/sit/prm/EgovProgramChangeRequstSelect.do'/>";
...
function insertChangeRequst() {
   	document.progrmChangeRequstForm.action = "<c:url value='/sit/prm/EgovProgramChangRequstStre.do'/>";
   	document.progrmChangeRequstForm.submit();
}
...
function selectUpdtChangeRequstListDetail(progrmFileNm, tmpNo) {
	...
	document.progrmChangeRequstForm.action = "<c:url value='/sit/prm/EgovProgramChangRequstDetailSelect.do'/>";
	document.progrmChangeRequstForm.submit();
}
...
<form name="progrmChangeRequstForm" action ="<c:url value='/sit/prm/EgovProgramChangeRequstSelect.do'/>?pageIndex=1" method="post">
<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   <h1><img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;프로그램변경요청</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%"></td>
 ...
 <tr>
  <td width="100%">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="프로그램변경요청  조건검색">
      ...
      <tr>
        <th width="20%" height="40" class="" scope="row" ><label for="searchKeyword">프로그램파일명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
        <td width="80%">
          <table border="0" cellspacing="0" cellpadding="0" align="left">
            <tr>
              <td >&nbsp;<input name="searchKeyword" type="text" title="검색조건" class="input-sm input-search"></td>
              <td width="5%"></td>
              <td><span class="button"><input type="submit" value="<spring:message code="button.search" />" onclick="selectProgrmChangeRequstList(); return false;"></span></td>
            </tr>
          </table>
        </td>
      </tr>
  ...
  <tr>
    ...
    <td width="25%" height="10">&nbsp;
          <table border="0" cellspacing="0" cellpadding="0" align="right">
            <tr>
              <td width="5%"></td>
              <td><span class="button"><a href="<c:url value='/sit/prm/EgovProgramChangRequstStre.do'/>" onclick="insertChangeRequst(); return false;"><spring:message code="button.create" /></a></span></td>
              <td width="10"></td>
            </tr>
          </table>
    </td>
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>
      <form name="item" method="post" action="<c:url value='/sit/prm/EgovProgramChangRequstDetailSelect.do'/>">

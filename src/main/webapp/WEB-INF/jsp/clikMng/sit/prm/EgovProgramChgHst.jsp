...
//	document.programChgHstForm.searchKeyword.value =
	...
	document.programChgHstForm.action = "<c:url value='/sit/prm/EgovProgramChgHstListSelect.do'/>";
...
function selectChgHstListDetail(progrmFileNm, tmp_no) {
	...
	document.programChgHstForm.action = "<c:url value='/sit/prm/EgovProgramChgHstListDetailSelect.do'/>";
	document.programChgHstForm.submit();
}
-->
</script>
...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="programChgHstForm" action ="<c:url value='/sit/prm/EgovProgramChgHstListSelect.do'/>" method="post">
<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   <h1><img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;프로그램변경이력</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%"></td>
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  <tr>
    <td class="lt_text3" style="cursor:hand;" nowrap>
        <form name="item" method="post" action="<c:url value='/sit/prm/EgovProgramChgHstListDetailSelect.do'/>">

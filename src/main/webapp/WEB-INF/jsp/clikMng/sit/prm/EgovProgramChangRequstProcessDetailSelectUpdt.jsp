...
<link rel="stylesheet" href="<c:url value='/css/clikmng/cmm/com.css' />" type="text/css">
<link rel="stylesheet" href="<c:url value='/css/clikmng/cmm/button.css' />" type="text/css">
...
function updateChangRequstProcess(form) {
	if(confirm("<spring:message code="common.save.msg"/>")){
		if(!validateProgrmManageDtlVO(form)){
            ...
            form.action ="<c:url value='/sit/prm/EgovProgramChangRequstProcessDetailSelectUpdt.do' />";
			form.submit();
		}
	}
}
...
function deleteChangRequstProcess(form) {
   form.action = "<c:url value='/sit/prm/EgovProgramChangeRequstProcessDelete.do' />";
   form.submit();
}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/sit/prm/EgovProgramChangeRequstProcessListSelect.do' />";
}
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;프로그램변경요청처리상세조회/수정</h1></td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/clikmng/sit/prm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;변경처리내역</td>
 </tr>
</table>
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="변경처리내역 ">
   	<caption>변경처리내역</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="processDe">변경처리일자</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>&nbsp;
	  ...
	  <img name="calendarImg" src="<c:url value='/images/clikmng/cmm/icon/bu_icon_carlendar.gif' />" alt='달력창팝업버튼이미지'></a>
    </td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="opetrId">변경처리자</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>
      &nbsp;
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="processSttus">변경처리상태</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>&nbsp;
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/clikmng/sit/prm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="" /><label for="rqesterCn">&nbsp;변경요청내역</label></td>
 </tr>
</table>
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="변경요청내역 ">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterNo">요청번호</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" /></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterPersonId">요청자ID</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" /></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterDe">요청일자</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" /></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterSj">요청제목</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" /></th>
    <td width="80%" nowrap>
...
<table width="717" border="0" cellspacing="0" cellpadding="0" align="left">
	<tr>
	  <td width="90%"></td>
	  <td><span class="button"><a href="<c:url value='/sit/prm/EgovProgramChangeRequstProcessListSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>
	  <td width="5%"></td>

...
<script language="javascript1.2"  type="text/javaScript" src="<c:url value='/js/clikmng/sts/calendar.js' />"></script>
<script language="javascript1.2"  type="text/javaScript" src="<c:url value='/js/clikmng/sym/cal/EgovCalPopup.js' />"></script>
...
function linkPage(pageNo){
	...
	document.programChangeRequstProcessListForm.action = "<c:url value='/sit/prm/EgovProgramChangeRequstProcessListSelect.do'/>";
...
function selectChangeRequstProcessListDetail(progrmFileNm, tmpNo) {
	...
	document.programChangeRequstProcessListForm.action = "<c:url value='/sit/prm/EgovProgramChangRequstProcessDetailSelect.do'/>";
	document.programChangeRequstProcessListForm.submit();
}
...
function fncSearchSpan(vSearch) {
	...
	if(vSearch == "1"){
        ...
        searchSpan.innerHTML += "요청일자&nbsp;"
            ...
            + " <a href=\"javascript:fn_egov_NormalCalendar(programChangeRequstProcessListForm, programChangeRequstProcessListForm.searchKeywordFrom,'');\" style=\"selector-dummy:expression(this.hideFocus=false);\"><img src=\"<c:url value='/images/clikmng/cmm/icon/bu_icon_carlendar.gif'/>\" name=\"cal_img1\" id=\"cal_img1\" border=\"0\" title=\"달력\" alt=\"달력\"><//a> ~ "
            + "<input name='searchKeywordTo'   type='text' size='8' value=''  maxlength='8'>"
            + " <a href=\"javascript:fn_egov_NormalCalendar(programChangeRequstProcessListForm,programChangeRequstProcessListForm.searchKeywordTo,'');\" style=\"selector-dummy:expression(this.hideFocus=false);\"><img src=\"<c:url value='/images/clikmng/cmm/icon/bu_icon_carlendar.gif'/>\" name=\"cal_img2\" id=\"cal_img2\" border=\"0\" title=\"달력\" alt=\"달력\"><//a>";


 //                             + "<input name='searchKeywordFrom' type='text' size='10' value=''  maxlength='14' >"
 //                             + "<img src='/images/clikmng/sts/ico_cal.gif' />' name='cal_img1' id='cal_img1' border='0' title='달력' onClick='popUpCalendar(this, searchKeywordFrom, \"yyyymmdd\")' style='cursor:pointer;'> ~ "
 //                             + "<input name='searchKeywordTo'   type='text' size='10' value=''  maxlength='14' >"
 //                             + "<img src='/images/clikmng/sts/ico_cal.gif' />' name='cal_img2' id='cal_img2' border='0' title='달력' onClick='popUpCalendar(this, searchKeywordTo, \"yyyymmdd\")' style='cursor:pointer;'>";
	}else if(vSearch == "4"){
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<c:url value='/images/clikmng/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;프로그램변경요청처리</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%"></td>
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  ...
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>
        <form name="item" method="post" action="<c:url value='/sit/prm/EgovProgramChangRequstProcessDetailSelect.do'/>">

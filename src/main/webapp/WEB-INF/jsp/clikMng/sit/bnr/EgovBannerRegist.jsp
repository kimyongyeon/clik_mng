...
function fncBannerInsert() {
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/sit/bnr/addBanner.do'/>";
...
<DIV id="page-wrapper">        
    ...
    <!-- /row -->
			...
			<DIV class="panel-heading">
				...
				<form:form commandName="banner" method="post" action="${pageContext.request.contextPath}/sit/bnr/addBanner.do' />" enctype="multipart/form-data">
				<form:hidden path="ntceBgnde" />
				<form:hidden path="ntceEndde" /> 
				<input type="hidden" name="posblAtchFileNumber" value="1" >
				<input type="hidden" name="bannerImage">

				<table width="100%" cellpadding="8" class="table table-striped table-bordered" summary="홍보존 정보를 입력하는 항목">
				  <tr>
				  ...
				  <tr>
				    ...
				    <td class="lt_text" nowrap>
				        <input type="file" name="file_1" id="egovComFileUploader" title="홍보존이미지" onchange="javascript:fncOnChangeImage();">
				    </td>
				  </tr>
				  <tr>
				    <th class="required_text" width="20%" scope="row"><label for="bannerDc">홍보존 설명</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
				    <td class="lt_text" nowrap>
...
<%-- 				    
				  <tr>
				    <th class="required_text" width="20%" scope="row"><label for="bassImageUseAt">기본이미지 사용여부</label><img src="<c:url value='/images/clikmng/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
				    <td class="lt_text" nowrap>
 ...
 --%>				    
				  <tr>
				    ...
				    <input type="text" id="ntceBgndeYYYMMDD" style="width:100px;" size="10" maxlength="10" class="readOnlyClass" readonly title="게시기간">
				    ...
				    &nbsp;&nbsp;~&nbsp;&nbsp;
				    <input type="text" id="ntceEnddeYYYMMDD" style="width:100px;" size="10" maxlength="10" class="readOnlyClass" readonly title="게시기간">
				  ...
				  <tr>
				    ...
				    <td class="lt_text" nowrap><input name="regDate" id="regDate" title="등록일시" type="text" value="<c:out value="${banner.regDate}"/>" maxLength="20" size="20" class="form-control input-sm" readonly ></td>
				  </tr>
				</table>

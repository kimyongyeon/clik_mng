...
function fnGroupRegist() {
	if(confirm("등록 하시겠습니까?")){
	    var f = document.getElementById("writeForm");
	    f.cmd.value = 'regist';
	    f.action = "<c:url value='/mim/GroupRegist.do'/>";
	    f.submit();
	}
}
			...
			<h2>그룹 등록</h2>
				...
				<table class="table table-striped table-bordered table-hover "  id="">
					...
					<tbody>
						<tr>
							<th>그룹명</th>
							<td><input type="text" name="groupNm"  id="groupNm" class="ip input-sm" style="width:30%;" /></td>
						</tr>
						<tr>
							<th>설명</th>
							<td><input type="text" name="dc" id="dc" class="ip input-sm" style="width:100%;" /></td>
						</tr>
						<tr>
				...
				<p class="tr">
					...
					<button type="button" class="btn btn-success" onclick="fnGroupRegist();">등록</button>
				</p>
        </div>
        <!-- /#page-wrapper -->
</form>
...
function addTextarea(obj) {
	...
	var list = new Array();
 	...
 	if (document.writeForm.groupArea.value == "") {

 ...
 * </pre>
 */
public class CmmCodeVO extends CmmCode implements Serializable {
	...
	/**
	 * enterDepth 값을 설정한다.
	 * @param enterDepth String
	 */			
	public String getEnterDepth() {
		return enterDepth;
	}
	 ...
	 * @param enterDepth String
	 */		
	public void setEnterDepth(String enterDepth) {
		this.enterDepth = enterDepth;
	}

	/**
	 * commCdNm 값을 설정한다.
	 * @param commCdNm String
	 */	

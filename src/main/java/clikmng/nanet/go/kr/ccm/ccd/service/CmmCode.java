 ...
 * </pre>
 */
public class CmmCode implements Serializable {
	...
	/**
	 * codeClCd attribute 를 리턴한다.
	 * @return String
	 */    
	public String getCodeClCd() {
		return codeClCd;
	}

	/**
	 * codeClCd attribute 을 설정한다.
	 * @return String
	 */  	
	public void setCodeClCd(String codeClCd) {
		this.codeClCd = codeClCd;
	}    

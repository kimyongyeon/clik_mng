...
import clikmng.nanet.go.kr.cmm.IncludedCompInfoVO;
...
public class EgovComIndexController implements ApplicationContextAware ,InitializingBean {
	...
	public String top(){
		return "clikMng/cmm/EgovUnitTop";
	}

	@RequestMapping("/EgovBottom.do")
	public String bottom(){
		return "clikMng/cmm/EgovUnitBottom";
	}
	...
	public String setContent(ModelMap model){
		...
		return "clikMng/cmm/EgovUnitContent";
	}
	...
	public String setLeftMenu(ModelMap model){
		...
		if(map == null){
			 ...
			 */
			try{
				Class loginController = Class.forName("clik.uat.uia.web.EgovLoginController");
				...
				LOG.error("No clik.uat.uia.web.EgovLoginController!!");
			}
		...
		return "clikMng/cmm/EgovUnitLeft";
	}
}

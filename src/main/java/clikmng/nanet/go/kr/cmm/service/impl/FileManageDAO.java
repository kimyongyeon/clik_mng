...
public class FileManageDAO extends EgovComAbstractDAO {
    ...
    /**
     * 여러 개의 파일에 대한 정보(속성 및 상세)를 등록한다. - 스페셜 검색
     * 
     * @param fileList
     * @return
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public String insertSpcFileInfs(List fileList) throws Exception {
    	FileVO vo = (FileVO)fileList.get(0);
    	String atchFileId = vo.getAtchFileId();
	    
    	insert("FileManageDAO.insertSpcFileInfs", vo);
	...
	update("FileManageDAO.deleteTNPFILE", fvo);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<FileVO> selectImageFile(FileVO vo) throws Exception {
	return list("FileManageDAO.selectImageFile", vo);
    }

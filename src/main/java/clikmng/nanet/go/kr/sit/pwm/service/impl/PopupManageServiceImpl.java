...
public class PopupManageServiceImpl extends AbstractServiceImpl implements PopupManageService {
	 ...
	 */
	public void deletePopupFile(PopupManageVO popupManageVO) throws Exception{
		FileVO fileVO = (FileVO)dao.selectPopupFile(popupManageVO);
		if(fileVO != null)
		{

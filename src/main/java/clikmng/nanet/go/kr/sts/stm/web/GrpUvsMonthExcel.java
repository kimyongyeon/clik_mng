...
public class GrpUvsMonthExcel extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String,Object> ModelMap
		...
		cell.setCellStyle(style);
		worksheet.addMergedRegion(new Region(2,(short)5,2,(short)6));// cell 병합
		...
		try {
    		for(int i=0; i<list.size(); i++)
    		{
                ...
                cell = row.createCell(0);
                cell.setCellValue(item.getTarget_date());
                cell.setCellStyle(style);
                ...
                cell = row.createCell(5);
                cell.setCellValue(pcAccCnt + moAccCnt);
                cell.setCellStyle(style_number);
                
                cell = row.createCell(6);
                cell.setCellValue(pcQurCnt + moQurCnt);
                cell.setCellStyle(style_number);
            ...
            cell = row.createCell(5);
            cell.setCellValue(pcAccCntSum + moAccCntSum);
            cell.setCellStyle(style_number);
            
            cell = row.createCell(6);
            cell.setCellValue(pcQurCntSum + moQurCntSum);
            cell.setCellStyle(style_number);
		} catch (Exception e) {

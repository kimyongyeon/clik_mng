...
public interface MenuManageService {
	 ...
	 * @exception Exception
	 */
	MenuManageVO selectMenuManage(MenuManageVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	void updateMenuOrd(MenuManageVO vo) throws Exception;	
	 ...
	 * @exception Exception
	 */
	List selectMenuListByLevel(MenuManageVO searchVO) throws Exception;
	 ...
	 * @exception Exception
	 */
	List selectApplyMenuList() throws Exception;	
	 ...
	 * @exception Exception
	 */
	void deleteUseMenu() throws Exception;	
	 ...
	 * @exception Exception
	 */
	void insertApplyMenuList(MenuManageVO vo) throws Exception;	

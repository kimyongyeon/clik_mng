package clikmng.nanet.go.kr.mna.rmt.service;
...
public class RoleManage extends ComDefaultVO {
	...
	public String getRoleClCode() {
		return roleClCode;
	}
	public void setRoleClCode(String roleClCode) {
		this.roleClCode = roleClCode;
	}

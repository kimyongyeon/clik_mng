package clikmng.nanet.go.kr.mna.mcm.web;
...
import clikmng.nanet.go.kr.mna.mcm.service.MenuCreatVO;
import clikmng.nanet.go.kr.mna.mcm.service.MenuSiteMapVO;
import clikmng.nanet.go.kr.mna.mcm.service.impl.MenuCreateManageService;
...
public class MenuCreateManageController {
	...
	@RequestMapping(value = "/mna/mcm/EgovMenuCreatManageSelect.do")
	public String selectMenuCreatManagList(
		...
		return "clikMng/mna/mcm/EgovMenuCreatManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mna/mcm/EgovMenuCreatSelect.do")
	public String selectMenuCreatList(
		...
		return "clikMng/mna/mcm/EgovMenuCreat";
	}
	 ...
	 *            String
	 * @return 출력페이지정보 등록처리시 "forward:/mna/mcm/EgovMenuCreatSelect.do"
	 * @exception Exception
	 */
	@RequestMapping("/mna/mcm/EgovMenuCreatInsert.do")
	public String insertMenuCreatList(
		...
		return "forward:/mna/mcm/EgovMenuCreatSelect.do";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mna/mcm/EgovMenuCreatSiteMapSelect.do")
	public String selectMenuCreatSiteMap(
		...
		menuSiteMapVO.setCreatPersonId(user.getMngrId());
		model.addAttribute("resultVO", menuSiteMapVO);
		return "clikMng/mna/mcm/EgovMenuCreatSiteMap";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mna/mcm/EgovMenuCreatSiteMapInsert.do")
	public String selectMenuCreatSiteMapInsert(
		...
		/* 사이트맵 파일 생성 위치 지정 */
		String path = MenuCreateManageController.class.getResource("").getPath().substring(0, MenuCreateManageController.class.getResource("").getPath().lastIndexOf("WEB-INF"));
		menuSiteMapVO.setTmpRootPath(path);
		menuSiteMapVO.setBndeFilePath("/html/egovframework/com/mna/mcm/");
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mna/mcm/EgovSiteMap.do")
	public String selectSiteMap(
		...
		model.addAttribute("resultVO", menuSiteMapVO);
		return "clikMng/mna/mcm/EgovSiteMap";
	}

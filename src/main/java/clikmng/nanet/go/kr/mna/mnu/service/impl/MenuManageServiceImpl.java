package clikmng.nanet.go.kr.mna.mnu.service.impl;
...
import clikmng.nanet.go.kr.sit.prm.service.impl.ProgrmManageDAO;
...
public class MenuManageServiceImpl extends AbstractServiceImpl implements MenuManageService{
	 ...
	 * @exception Exception
	 */
	public MenuManageVO selectMenuManage(MenuManageVO vo) throws Exception{
	 ...
	 * @exception Exception
	 */
	public void updateMenuOrd(MenuManageVO vo) throws Exception {
		menuManageDAO.updateMenuOrd(vo);
	}	
	 ...
	 * @exception Exception
	 */
	public List selectMenuListByLevel(MenuManageVO searchVO) throws Exception {
   		return menuManageDAO.selectMenuListByLevel(searchVO);
	}
...
/*### 일괄처리 프로세스 ###*/
	 ...
	 * @exception Exception
	 */
	public List<MenuManageVO> selectApplyMenuList() throws Exception {
   		return menuManageDAO.selectApplyMenuList();
	}
	 ...
	 * @exception Exception
	 */
	public void deleteUseMenu() throws Exception {
		menuManageDAO.deleteUseMenu();
	}
	 ...
	 * @exception Exception
	 */
	public void insertApplyMenuList(MenuManageVO vo) throws Exception {
		menuManageDAO.insertApplyMenuList(vo);
	}
}
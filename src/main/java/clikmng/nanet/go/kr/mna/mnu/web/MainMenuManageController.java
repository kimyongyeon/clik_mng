...
public class MainMenuManageController {
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mna/mnu/EgovMainMenuIndex.do")
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mna/mnu/EgovMainMenu.do")
...
//        } else {
//        	// 오류 페이지 이동
        	return "clikMng/cmm/error/egovError";
//        }
    }
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mna/mnu/EgovMainMenuHead.do")
...
//		if (!user.getId().equals("")) {
			...
			// G일반 / E기업 / U업무
//			if (user.getUserSe().equals("USR")) {
//        		return "clikMng/main_head"; //"EgovMainViewG"; 일반사용자
//        	} else {
//        		return "clikMng/main_headG"; 
//        	}
//        } else {
        	// 오류 페이지 이동
        	return "clikMng/cmm/error/egovError";
//        }
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mna/mnu/EgovMainMenuLeft.do")
...
//    	menuManageVO.setTmpUniqId(user.getUniqId());
     ...
     */
    /*Right Menu 조회*/
    @RequestMapping(value="/mna/mnu/EgovMainMenuRight.do")
...
//    	forwardURL = menuManageService.selectLastMenuURL(iMenuNo, user.getUniqId());
    ...
    @RequestMapping(value="/mna/mnu/EgovMainMenuHome.do")
...
//        		return "clikMng/EgovMainViewG"; //"EgovMainViewG"; 일반사용자
        		
//        	}else if(user.getUserSe().equals("USR")){//2011.09.07
        		//return "clikMng/EgovIndvdlpgeDetail";
//        		return "clikMng/EgovMainView";
//        	}
//        	else {
        		//return "clikMng/EgovMainView";//1차 사업 메인화면 
//        		return "clikMng/EgovMainView2";//2차 사업 메인화면
//        	}
//        } else {
        	// 오류 페이지 이동
        	return "clikMng/cmm/error/egovError";

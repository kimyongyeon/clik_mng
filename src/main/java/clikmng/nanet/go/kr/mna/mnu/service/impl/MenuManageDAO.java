...
public class MenuManageDAO extends EgovComAbstractDAO{
	...
	public MenuManageVO selectMenuManage(MenuManageVO vo)throws Exception{
		return (MenuManageVO)selectByPk("menuManageDAO.selectMenuManage", vo); 
	}
	 ...
	 * @exception Exception
	 */
	public void updateMenuOrd(MenuManageVO vo){
		update("menuManageDAO.updateMenuOrd", vo);
	}	
	...
	public List selectMenuListByLevel(MenuManageVO searchVO) throws Exception{		
		return list("menuManageDAO.selectMenuListByLevel", searchVO);
	}
	...
	public List<MenuManageVO> selectApplyMenuList() throws Exception{
		return list("menuManageDAO.selectApplyMenuList", "");
	}   
	 ...
	 * @exception Exception
	 */
	public void deleteUseMenu(){
		delete("menuManageDAO.deleteUseMenu", "");
	}
	 ...
	 * @exception Exception
	 */
	public void insertApplyMenuList(MenuManageVO vo){
		delete("menuManageDAO.insertApplyMenuList", vo);
	}
}
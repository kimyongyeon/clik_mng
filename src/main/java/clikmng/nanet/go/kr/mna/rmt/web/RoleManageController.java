package clikmng.nanet.go.kr.mna.rmt.web;
...
public class RoleManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/mna/rmt/EgovRoleListView.do")
    public String selectRoleListView()
            throws Exception {
        return "clikMng/mna/rmt/EgovRoleManage";
    }    
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="롤관리", listUrl="/mna/rmt/EgovRoleList.do", order = 90,gid = 20)
    @RequestMapping(value="/mna/rmt/EgovRoleList.do")
	public String selectRoleList(@ModelAttribute("roleManageVO") RoleManageVO roleManageVO, 
		...
		roleManageVO.setRoleClCode(StringUtil.nullConvert(roleManageVO.getRoleClCode()));
    	if(roleManageVO.getRoleClCode().equals(""))
    		roleManageVO.setRoleClCode("CLIK");
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/mna/rmt/EgovRole.do")
	public String selectRole(@RequestParam("roleCode") String roleCode,
        ...
        model.addAttribute("cmmCodeDetailList", getCmmCodeDetailList(new ComDefaultCodeVO(),"RKS012"));

        return "clikMng/mna/rmt/EgovRoleUpdate";
	}
	 ...
	 * @exception Exception
	 */     
    @RequestMapping("/mna/rmt/EgovRoleInsertView.do")
    public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO,
    							ServletRequest request,
    		                      ModelMap model) throws Exception {
    	
    	String roleClCode = request.getParameter("roleClCode");
    	
    	authorManageVO.setAuthorManageList(AuthorManageService.selectAuthorAllList(authorManageVO));
        model.addAttribute("authorManageList", authorManageVO.getAuthorManageList());
        model.addAttribute("cmmCodeDetailList", getCmmCodeDetailList(new ComDefaultCodeVO(),"RKS012"));
        model.addAttribute("roleClCode", roleClCode);
        
        return "clikMng/mna/rmt/EgovRoleInsert";
    }
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/mna/rmt/EgovRoleInsert.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/mna/rmt/EgovRoleUpdate.do")
	public String updateRole(@ModelAttribute("roleManage") RoleManage roleManage,
    	...
    	return "forward:/mna/rmt/EgovRole.do";
		}
	}
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/mna/rmt/EgovRoleDelete.do")
	public String deleteRole(@ModelAttribute("roleManage") RoleManage roleManage,
    	...
    	return "forward:/mna/rmt/EgovRoleList.do";
	 ...
	 * @exception Exception
	 */   
	@RequestMapping(value="/mna/rmt/EgovRoleListDelete.do")

package clikmng.nanet.go.kr.cop.cmt.web;
...
import clikmng.nanet.go.kr.cop.bbs.service.Comment;
import clikmng.nanet.go.kr.cop.bbs.service.CommentVO;
import clikmng.nanet.go.kr.cop.bbs.service.BBSCommentService;
...
public class BBSCommentController {
	...
	if (commentVO.getType().equals("head")) {
	    return "clikMng/cop/cmt/EgovCommentList";
	}
	////----------------------------------------
...
*/ 
	...
	model.addAttribute("sessionUniqId", "TESTER");
	commentVO.setWrterNm("TESTER");
...
*/ 
	...
	if (isAuthenticated) {
		...
		comment.setFrstRegisterId("TESTER");
	    comment.setWrterId("TESTER");
...
*/ 
	...
	if (isAuthenticated) {
	    comment.setLastUpdusrId("TESTER");

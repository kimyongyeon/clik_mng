package clikmng.nanet.go.kr.cop.faq.web;
...
import clikmng.nanet.go.kr.cop.faq.service.FaqManageService;
...
public class FaqManageController {
     ...
     */
/*    
	@RequestMapping(value="/cop/faq/EgovMain.do")
    public String egovMain(ModelMap model) throws Exception {
    	return "clikMng/cop/faq/EgovMain";
    }
*/    
    /**
     * 메뉴를 조회한다.
     * @param model
     * @return	"/cop/faq/EgovLeft"
     * @throws Exception
     */
/*	
    @RequestMapping(value="/cop/faq/EgovLeft.do")
    public String egovLeft(ModelMap model) throws Exception {
    	return "clikMng/cop/faq/EgovLeft";
    }
*/	    
    /**
     * FAQ 목록을 조회한다.
     * @param searchVO
     * @param model
     * @return	"/cop/faq/EgovFaqListInqire"
     * @throws Exception
     */
    @IncludedInfo(name="FAQ관리", order = 540 ,gid = 50)
    @RequestMapping(value="/cop/faq/FaqListInqire.do")
    public String selectFaqList(@ModelAttribute("searchVO") FaqManageDefaultVO searchVO, ModelMap model) throws Exception {
        ...
        return "clikMng/cop/faq/EgovFaqListInqire";
    } 
     ...
     * @param searchVO
     * @param model
     * @return	"/cop/faq/EgovFaqDetailInqire"
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqListDetailInqire.do")
    public String	selectFaqListDetail(FaqManageVO faqManageVO,
        ...
        return	"clikMng/cop/faq/EgovFaqDetailInqire";
    }
     ...
     * @param faqManageVO
     * @param searchVO
     * @return	"forward:/cop/faq/FaqListDetailInqire.do"
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqInqireCoUpdt.do")
     ...
     * @param searchVO
     * @param model
     * @return	"/cop/faq/EgovFaqCnRegist"
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqCnRegistView.do")
    public String insertFaqCnView(
        ...
        return "clikMng/cop/faq/EgovFaqCnRegist";
     ...
     * @param faqManageVO
     * @param bindingResult
     * @return	"forward:/cop/faq/FaqListInqire.do"
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqCnRegist.do")
    public String insertFaqCn(
		...
		if(bindingResult.hasErrors()){
			...
			return "clikMng/cop/wor/EgovFaqCnRegist";
     ...
     * @param searchVO
     * @param model
     * @return	"/cop/faq/EgovFaqCnUpdt"
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqCnUpdtView.do")
    public String updateFaqCnView(@RequestParam("faqId") String faqId ,
        ...
        return "clikMng/cop/faq/EgovFaqCnUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqCnUpdt.do")
    public String updateFaqCn(@RequestParam("atchFileAt") String atchFileAt ,
		...
		if(bindingResult.hasErrors()){
			...
			return "clikMng/cop/wor/EgovFaqCnUpdt";
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/faq/FaqCnDelete.do")

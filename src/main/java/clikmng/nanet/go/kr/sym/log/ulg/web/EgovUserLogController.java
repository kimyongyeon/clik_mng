package clikmng.nanet.go.kr.sym.log.ulg.web;
...
import clikmng.nanet.go.kr.sym.log.ulg.service.EgovUserLogService;
import clikmng.nanet.go.kr.sym.log.ulg.service.UserLog;
...
public class EgovUserLogController {
	...
	public String selectUserLogInf(@ModelAttribute("searchVO") UserLog userLog,
		...
		return "clikMng/sym/log/ulg/EgovUserLogList";
	}
	...
	public String selectUserLog(@ModelAttribute("searchVO") UserLog userLog,
		...
		return "clikMng/sym/log/ulg/EgovUserLogInqire";
	}

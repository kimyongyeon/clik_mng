package clikmng.nanet.go.kr.sym.log.clg.web;
...
import clikmng.nanet.go.kr.sym.log.clg.service.EgovLoginLogService;
...
public class EgovLoginLogController {
	...
	public String selectLoginLogInf(@ModelAttribute("searchVO") LoginLog loginLog,
		...
		return "clikMng/sym/log/clg/EgovLoginLogList";
	}
	...
	public String selectLoginLog(@ModelAttribute("searchVO") LoginLog loginLog,
		...
		return "clikMng/sym/log/clg/EgovLoginLogInqire";
	}

package clikmng.nanet.go.kr.sym.ccm.zip.web;
...
import clikmng.nanet.go.kr.sym.ccm.zip.service.EgovCcmRdnmadZipManageService;
import clikmng.nanet.go.kr.sym.ccm.zip.service.EgovCcmZipManageService;
import clikmng.nanet.go.kr.sym.ccm.zip.service.Zip;
import clikmng.nanet.go.kr.sym.ccm.zip.service.ZipVO;
...
public class EgovCcmZipManageController {
	 ...
	 * @param model
	 * @return "clikMng/sym/ccm/zip/EgovCcmZipSearchPopup"
	 * @throws Exception
	 */
     ...
     * @param searchVO
     * @param model
     * @return "clikMng/sym/ccm/zip/EgovCcmZipSearchList"
     * @throws Exception
     */
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "clikMng/sym/ccm/zip/EgovCcmZipRegist"
	 * @throws Exception
	 */
...
//    		zip.setFrstRegisterId(loginVO.getUniqId());
	 ...
	 * @param commandMap
	 * @param model
	 * @return "clikMng/sym/ccm/zip/EgovCcmExcelZipRegist"
	 * @throws Exception
	 */
	 ...
	 * @param zip
	 * @param model
	 * @return "clikMng/sym/ccm/zip/EgovCcmZipDetail"
	 * @throws Exception
	 */
     ...
     * @param searchVO
     * @param model
     * @return "clikMng/sym/ccm/zip/EgovCcmZipList"
     * @throws Exception
     */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "clikMng/sym/ccm/zip/EgovCcmZipModify"
	 * @throws Exception
	 */

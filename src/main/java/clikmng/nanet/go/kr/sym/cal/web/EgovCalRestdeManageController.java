package clikmng.nanet.go.kr.sym.cal.web;
...
import clikmng.nanet.go.kr.sym.cal.service.EgovCalRestdeManageService;
import clikmng.nanet.go.kr.sym.cal.service.Restde;
import clikmng.nanet.go.kr.sym.cal.service.RestdeVO;
...
public class EgovCalRestdeManageController {
	...
	@RequestMapping(value="/sym/cal/callCal.do")
 	public String callCal (Restde restde, BindingResult bindingResult
		...
		if(bindingResult.hasErrors()){
			...
			return "clikMng/cmm/error/dataAccessFailure";
		...
		return "clikMng/sym/cal/EgovCalendar";
	}    
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovNormalCalendar"
	 * @throws Exception
	 */
	 ...
	 * 행정달력 팝업 메인창을 호출한다.
	 * @param model
	 * @return "clikMng/sym/cal/EgovAdministCalPopup"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovAdministCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovNormalDayCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovNormalWeekCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovNormalMonthCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovNormalYearCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovAdministDayCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovAdministWeekCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovAdministMonthCalendar"
	 * @throws Exception
	 */
	 ...
	 * @param restde
	 * @param model
	 * @return "clikMng/sym/cal/EgovAdministYearCalendar"
	 * @throws Exception
	 */
     ...
     * @param bindingResult
     * @param model
     * @return "clikMng/sym/cal/EgovRestdeRegist"
     * @throws Exception
     */
...
//    	restde.setFrstRegisterId(loginVO.getUniqId());
     ...
     * @param restde
     * @param model
     * @return "clikMng/sym/cal/EgovRestdeDetail"
     * @throws Exception
     */
     ...
     * @param searchVO
     * @param model
     * @return "clikMng/sym/cal/EgovRestdeList"
     * @throws Exception
     */
     ...
     * @param commandMap
     * @param model
     * @return "clikMng/sym/cal/EgovRestdeModify"
     * @throws Exception
     */

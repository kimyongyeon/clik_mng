package clikmng.nanet.go.kr.sym.log.lgm.web;
...
import clikmng.nanet.go.kr.sym.log.lgm.service.EgovSysLogService;
import clikmng.nanet.go.kr.sym.log.lgm.service.SysLog;
...
public class EgovSysLogController {
	...
	public String selectSysLogInf(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "clikMng/sym/log/lgm/EgovSysLogList";
	}
	...
	public String selectSysLog(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "clikMng/sym/log/lgm/EgovSysLogInqire";
	}

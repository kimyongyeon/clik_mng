...
public class SecuredObjectDAO {
    ...
    +"  FROM rule_infor a, authority_rule b    "
    ...
    public static final String DEF_REGEX_MATCHED_REQUEST_MAPPING_QUERY_ORACLE10G =
        ...
        + " FROM TNPSECURED_RESOURCES a, TNPSECURED_RESOURCES_ROLE b   "
...
//        + "FROM TNPROLES_HIERARCHY a LEFT JOIN TNPROLES_HIERARCHY b on (a.CHLDRN_ROLE = b.PARNTS_ROLE) ";
...
//        LinkedHashMap resourcesMap = new LinkedHashMap();
        ...
        List<Map<String, Object>> resultList = this.namedParameterJdbcTemplate.queryForList(sqlRolesAndResources, new HashMap());

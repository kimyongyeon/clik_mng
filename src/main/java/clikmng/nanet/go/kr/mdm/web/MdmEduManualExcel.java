...
public class MdmEduManualExcel extends AbstractExcelView{
...
//				}
				...
				//서비스URL
				cell = row.createCell(13);
				cell.setCellValue("http://clik.nanet.go.kr/potal/search/searchView.do?collection=manual&DOCID="+vo.getOUTBBS_CN());
				cell.setCellStyle(style);
